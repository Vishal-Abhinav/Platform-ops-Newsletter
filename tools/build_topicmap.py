...
<nav>
  ...
  <div class="nav-right">{chrome.TOGGLE}<a href="{UP}terminal/index.html" class="nav-lab nav-terminal">TERMINAL</a><a href="{UP}about/index.html" class="nav-lab nav-about">ABOUT</a><a href="{UP}index.html#subscribe" class="nav-logo nav-sub" style="font-size:11px;letter-spacing:1.6px;font-family:'DM Mono',monospace">SUBSCRIBE</a></div>
</nav>
